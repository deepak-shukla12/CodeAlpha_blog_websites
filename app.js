...
mongoose.connect("mongodb://localhost:27017/blogDB",{useNewUrlParser: true},{useUnifiedTopology: true}).then(()=>console.log("connection successfull..."))
...
app.get("/posts/:postId",function(req,res){
    ...
    Post.findOne({_id: posttitle},function(err,post){
